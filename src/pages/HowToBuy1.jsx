...
function HowToBuy1(props) {
  ...
  return (
    <div className="bg-jar d-flex justify-content-center alights-items-center">
      <div className="modal-dialog modal-dialog-centered m-0">
        <div className="modal-content ms-0">
          <div className="modal-header justify-content-center text-center">
            <h5 className="modal-title">{t("how-to-buy.how")} </h5>
            <a className="p-absolute ms-3" href="./">
              <h6>{t("how-to-buy.back")}</h6>
            </a>
          </div>
          <div className="modal-body mt-16">
            <p>{t("how-to-buy.link")}</p>
          </div>
          <div className="modal-footer justify-content-center">
            ...
            {/* <a href="https://twitter.com/IwerTrainings?t=JIdQ66DnzvfxYuv7oYuXoQ&s=09">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            {/* <a href="https://discord.com/invite/BBzM8w8VY5" className="ms-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
