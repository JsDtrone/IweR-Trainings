  ...
  return (
    <motion.div initial="hidden" whileInView="visible" class="z-top dsfdssf ">
      <motion.h1
        custom={2}
        variants={titles}
        class="bold-Title-ds text-center  d-flex justify-content-center align-items-center bg-answ"
      >
        {t("all.answers-title")}
      </motion.h1>
      ...
      <div class=" bg-blur">
        <div className="container">
                ...
                <div class="d-flex justify-content-center alight-item-center">
                  ...
                  >
                    <AnwerQU
                      ...
                      hrefff={
                        <a href="https://vk.com/iwervalorant">
                          <b className="no-eff">https://vk.com/iwervalorant</b>
                        </a>
                      }
                    />
                  </FirstChild>
          ...
          <motion.div custom={2} variants={answ}>
            {showButton && (
              <button
                className="btn-to-ani"
          ...
          <motion.div custom={3} variants={answ}>
            {showButton && (
              <button
                className="btn-to-ani"
          ...
          <motion.div custom={4} variants={answ}>
            {showButton && (
              <button
                className="btn-to-ani"
          ...
          <motion.div custom={5} variants={answ}>
            {showButton && (
              <button
                className="btn-to-ani"
