  ...
  return (
    <motion.div initial="hidden" whileInView="visible" class="z-top dsfdssf ">
      <motion.h1
        custom={2}
        variants={titles}
        class="bold-Title-ds bold-Title-dss m-0 text-center  d-flex justify-content-center align-items-center bg-answd color-yellow"
      >
        {t("all.answers-title")}
      </motion.h1>
                ...
                <div class="d-flex justify-content-center alight-item-center">
                  ...
                  >
                    <AnwerQU
                      ...
                      hrefff={
                        <a href="https://vk.com/iwercsgo">
                          <b className="no-eff">vk.com/iwercsgo</b>
                        </a>
                      }
                    />
                  </FirstChild>
